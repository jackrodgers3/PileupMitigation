...
def main(dR = 0.4):
    ...
    for i in range(1, 2):
        ...
        save_dir = r'D:\Data\Research\PUPPI\W_processed/'

        num_events_train = 140
        oname = save_dir + "dataset"+str(i)+"_graph_puppi_" + str(num_events_train) + "_disc"
        ...
        num_events_test = 30
        oname = save_dir + "dataset"+str(i)+"_graph_puppi_test_" + str(num_events_test) + "_disc"
        dataset_test = prepare_dataset(iname, num_events_test, dR, num_events_train)
        with open(oname, "wb") as fp:
            pickle.dump(dataset_test, fp)

        num_events_valid = 30
        oname = save_dir + "dataset"+str(i)+"_graph_puppi_val_" + str(num_events_valid) + "_disc"
