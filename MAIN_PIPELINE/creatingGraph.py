...
def main(dR = 0.8):
    ...
    iname = r"/depot/cms/users/gpaspala/GluGluHToBB_Pt-200ToInf_M-125_TuneCP5_MINLO_13TeV-powheg-pythia8/output_9.root"
    save_dir = r"/depot/cms/users/jprodger/PUPPI/Physics_Optimization/MAIN_PIPELINE/data/"
