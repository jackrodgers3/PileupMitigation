...
def arg_parse():
    ...
    parser.set_defaults(model_type='Gated',
                        ...
                        save_dir=r"/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment120824/output_f/",
                        jet_type = "W",
                        num_select_LV = 2,
                        num_select_PU = 30,
                        act_fn = 'relu'
...
def train(dataset, dataset_validation, args):
    ...
    args.num_select_LV = 3
    args.num_select_PU = 20
    
    args.hidden_dim = 128
    
    args.lr = 3e-4
    
    args.num_enc_layers = 4
...
def main():
    ...
    mstart = timer()
    train(dataset,dataset_validation,args_end)
    mend = timer()
    custom_arg = Args()
    ...
    custom_arg.weight_decay = args_end.weight_decay
    ##################
