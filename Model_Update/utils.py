...
def plot_discriminator(epoch, vals, trial_num, legends=['LV', 'PU'], postfix="", label="Discriminator", bins=50, xaxisrange=(0, 1), dir_name='.'):
    """
    ...
    plt.legend(loc=4)
    filename = dir_name + "/prob_plots/Discriminator_" + postfix + "_" + str(epoch) +".png"
...
def plot_training(
    ...
    #plt.savefig(dir_name + "/loss_graph" +" "+i+" " + postfix)
    ...
    #plt.savefig(dir_name + "/auc_graph_train" + " "+i+" " + postfix)
    ...
    #plt.savefig(dir_name + "/accuracy_graph" +" "+i+" "+ postfix)
