...
def arg_parse():
    ...
    parser.set_defaults(model_type='Gated',
                        ...
                        save_dir="/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt14/Wjets/",
                        jet_type = "W"
                        )
...
def train(dataset, dataset_validation, trial, args, batchsize):
    ...
    if args.pulevel == 20:
        ...
        num_select_PU = 282
    '''
    args.dropout = trial.suggest_float("dropout", 0.0, 0.2, step=0.025)
    rotate_mask = 11
    ...
    args.hidden_dim = trial.suggest_int("hidden_dim", 15, 25)
    
    args.lr = trial.suggest_float("lr", 0.0005, 0.0025, step=0.0002)
    ...
    while converge == False:
        ...
        for batch in training_loader:
            ...
            if count_event % 1000 == 0:
                ...
                if count_event == 1000 and best_validation_quant >= 0.13:
                    converge = True
                    break
                elif count_event == 8000 and best_validation_quant < 0.13:
                    converge = True
                    break
...
def main():
    ...
    if args_end.jet_type == "W":
        ...
        filelists = ["/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset1_graph_puppi_4000", "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset2_graph_puppi_4000",
        "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset3_graph_puppi_4000", "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset4_graph_puppi_4000", "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset8_graph_puppi_4000",
        "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset9_graph_puppi_4000","/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset11_graph_puppi_4000",
        "/depot/cms/users/jprodger/PUPPI/ZnewjetsdR0.4/dataset12_graph_puppi_4000"]
    phym.main(modelname, filelists, custom_arg)
    mbotime = mend - mstart
    print("main time " + str(mbotime))
    fig1 = optuna.visualization.plot_optimization_history(study, target_name = 'quant performance')
    fig2 = optuna.visualization.plot_param_importances(study)
    fig3 = optuna.visualization.plot_edf(study, target_name = 'quant performance')
