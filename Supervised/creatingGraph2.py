...
def main_regression(dR = 0.4):
    ...
    oname = r"C:\Users\jackm\PycharmProjects\PileupMitigation\Supervised\data2/train" + str(num_events_train)
    ...
    oname = r"C:\Users\jackm\PycharmProjects\PileupMitigation\Supervised\data2/valid" + str(num_events_valid)
    dataset_test = r_prepare_dataset(iname, num_events_valid, dR, num_events_train)
    with open(oname, "wb") as fp:
        pickle.dump(dataset_test, fp)
    fp.close()
    num_events_test = 5000
    oname = r"C:\Users\jackm\PycharmProjects\PileupMitigation\Supervised\data2/test" + str(num_events_test)
