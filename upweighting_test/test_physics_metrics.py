...
class Args(object):
    ...
    def __init__(self, model_type='Gated', do_boost=False, extralayers=False):
        ...
        self.save_dir = "/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment011925_focal/output_tuning/"
        self.num_select_LV = 7
        self.num_select_PU = 35
        self.lamb = 0.0000290
        self.f_alpha = 0.89156
        self.f_gamma = 1.11126
...
def main(modelname, filelists, custom_args):
    ...
    fig = plt.figure(figsize=(10, 8))
    plt.plot(masses_binned.statistic, ssl_masses_reldiff_means_binned.statistic, 'go', label='SSL')
    plt.plot(masses_binned.statistic, puppi_masses_reldiff_means_binned.statistic, 'ro', label='PUPPI')
    plt.plot(masses_binned.statistic, pf_masses_reldiff_means_binned.statistic, 'bo', label='PF')
    plt.plot(masses_binned.statistic, chs_masses_reldiff_means_binned.statistic, 'mo', label='CHS')
    plt.title('Mean mass vs. mean relative difference in mass')
    plt.xlabel(r'mean mass [GeV]')
    plt.ylabel(r'mean of $(m_{reco} - m_{truth})/m_{truth}$')
    plt.legend()
    ...
    fig = plt.figure(figsize=(10, 8))
    plt.plot(masses_binned.statistic, ssl_masses_reldiff_stds_binned.statistic, 'go', label='SSL')
    plt.plot(masses_binned.statistic, puppi_masses_reldiff_stds_binned.statistic, 'ro', label='PUPPI')
    plt.plot(masses_binned.statistic, pf_masses_reldiff_stds_binned.statistic, 'bo', label='PF')
    plt.plot(masses_binned.statistic, chs_masses_reldiff_stds_binned.statistic, 'mo', label='CHS')
    plt.title('Mean mass vs. std relative difference in mass')
    plt.xlabel(r'mean mass [GeV]')
    plt.ylabel(r'std of $(m_{reco} - m_{truth})/m_{truth}$')
    plt.legend()
   ...
   #  %matplotlib inline
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "JetNum.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "JetPT.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "JetMass.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "JetEta.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "JetPhi.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "GNNweight.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "GNNpuppi.pdf")
    ...
    plt.savefig(savefigdir + "neutral2d.pdf")
    ...
    plt.xlabel(r'puppi weight')
    plt.ylabel(r'SSL weight')
    plt.savefig(savefigdir + "chlv2d.pdf")
    ...
    plt.xlabel(r'puppi weight')
    plt.ylabel(r'SSL weight')
    plt.savefig(savefigdir + "chpu2d.pdf")
    ...
    plt.savefig(savefigdir + "SSLMassReso2d.pdf")
    ...
    plt.xlabel(r'mass [GeV]')
    plt.ylabel(r'mass resolution $(m_{reco} - m_{truth})/m_{truth}$')
    plt.savefig(savefigdir + "PUPPIMassReso2d.pdf")
    ...
    plt.xlabel(r'mass [GeV]')
    plt.ylabel(r'mass resolution $(m_{reco} - m_{truth})/m_{truth}$')
    plt.savefig(savefigdir + "PFMassReso2d.pdf")
    ...
    plt.xlabel(r'mass [GeV]')
    plt.ylabel(r'mass resolution $(m_{reco} - m_{truth})/m_{truth}$')
    plt.savefig(savefigdir + "CHSMassReso2d.pdf")
    ...
    plt.legend()
    plt.show()
    plt.savefig(savefigdir + "MET_diff.pdf")
...
if __name__ == '__main__':
    args = Args()
    modelname = "/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment011925_focal/output_tuning/best_valid_model_4.pt"
