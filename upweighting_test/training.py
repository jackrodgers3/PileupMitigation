...
def arg_parse():
    ...
    parser.add_argument("--f_weight", type=float, help='weight for final model sigmoid')
    ...
    parser.set_defaults(model_type='Gated',
                        ...
                        pulevel=80,
                        lamb = 7.4e-5,
                        training_path=r"C:\Users\jackm\PycharmProjects\PileupMitigation\upweighting_test\data\dataset_graph_puppi_10000",
                        validation_path=r"C:\Users\jackm\PycharmProjects\PileupMitigation\upweighting_test\data\dataset_graph_puppi_val_10000",
                        save_dir=r"C:\Users\jackm\PycharmProjects\PileupMitigation\upweighting_test\save_dir4/",
                        jet_type = "W",
                        num_select_LV = 7,
                        num_select_PU = 35,
                        act_fn = 'gelu',
...
def train(dataset, dataset_validation, args):
    ...
    wandb.init(
        project='Upweight_Test_Extended',
        config=wandb_config,
        name=f"sig{round(args.f_weight, 2)}"
    )
    ...
    while converge == False:
        ...
        for batch in training_loader:
            ...
            if count_event % 1000 == 0:
                ...
                train_accuracy_neu.append(train_acc_neu)
                valid_accuracy_neu.append(valid_acc_neu)
                train_accuracy_puppi.append(train_puppi_acc)
                valid_accuracy_puppi.append(valid_puppi_acc)
                train_accuracy_puppi_neu.append(train_puppi_acc_neu)
                valid_accuracy_puppi_neu.append(valid_puppi_acc_neu)
    ...
    plt.figure()
    plt.plot(epochs_valid, train_graph_SSLMassdiffMu, label = r'Semi-supervised_train_JetMass, $\mu$', linestyle = 'solid', linewidth = 1, color = 'g')
    plt.plot(epochs_valid, valid_graph_SSLMassdiffMu, label = r'Semi-supervised_valid_JetMass, $\mu$', linestyle = 'solid', linewidth = 1, color = 'b')
    plt.plot(epochs_valid, train_graph_PUPPIMassdiffMu, label = r'PUPPI_train_JetMass, $\mu$', linestyle = 'solid', linewidth = 1, color = 'r')
    ...
    plt.figure()
    plt.plot(epochs_valid, train_graph_SSLPtdiffMu, label = r'Semi-supervised_train_JetPt, $\mu$', linestyle = 'solid', linewidth = 1, color = 'g')
    plt.plot(epochs_valid, valid_graph_SSLPtdiffMu, label = r'Semi-supervised_valid_JetPt, $\mu$', linestyle = 'solid', linewidth = 1, color = 'b')
    plt.plot(epochs_valid, train_graph_PUPPIPtdiffMu, label = r'PUPPI_train_JetPt, $\mu$', linestyle = 'solid', linewidth = 1, color = 'r')
    ...
    plt.figure()
    plt.plot(epochs_valid, train_graph_SSLMassSigma, label = r'Semi-supervised_train_JetMass, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'g')
    plt.plot(epochs_valid, valid_graph_SSLMassSigma, label = r'Semi-supervised_valid_JetMass, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'b')
    plt.plot(epochs_valid, train_graph_PUPPIMassSigma, label = r'PUPPI_train_JetMass, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'r')
    ...
    plt.figure()
    plt.plot(epochs_valid, train_graph_SSLPtSigma, label = r'Semi-supervised_train_JetPt, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'g')
    plt.plot(epochs_valid, valid_graph_SSLPtSigma, label = r'Semi-supervised_valid_JetPt, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'b')
    plt.plot(epochs_valid, train_graph_PUPPIPtSigma, label = r'PUPPI_train_JetPt, $\sigma$', linestyle = 'solid', linewidth = 1, color = 'r')
...
def black_box_function():
    args = arg_parse()
    args.f_weight = random.uniform(2.0, 3.0)
...
def main():
    ...
    if inf == "W":
        ...
        args_end.f_gamma = 1.14
        args_end.act_fn = 'gelu'
        args_end.save_dir = r"/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment042025/output6/"
        mn = r"/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment042025/output6/best_valid_model.pt"
    
    #args_end.save_dir = r"/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment042025/output4/"
    ...
    modelname = r'C:\Users\jackm\PycharmProjects\PileupMitigation\upweighting_test\save_dir3/best_valid_model.pt'
    
    if args_end.jet_type == "W":
        filelists = [r"C:\Users\jackm\PycharmProjects\PileupMitigation\upweighting_test\data\dataset_graph_puppi_test_10000"]
    ...
    elif args_end.jet_type == "W_window":
        filelists = ["/depot/cms/users/jprodger/PUPPI/Physics_Optimization/Experiment042025/Z_data/dataset_graph_puppi_test_30000"]
