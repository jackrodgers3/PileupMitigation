...
import test_physics_metrics3 as phym
from test_physics_metrics3 import Args
import matplotlib
...
def arg_parse():
    ...
    parser.set_defaults(model_type='Gated',
                        ...
                        save_dir="/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt16/Wjets/",
                        jet_type = "W"
                        )
...
def train(dataset, dataset_validation, trial, args, batchsize):
    ...
    num_select_LV = trial.suggest_int("num_select_LV", 1, 10)
    num_select_PU = trial.suggest_int("num_select_PU", 10, 40)
    
    
    args.hidden_dim = trial.suggest_int("hidden_dim", 30, 50)
    
    args.lr = trial.suggest_float("lr", 0.001, 0.005, step=0.0002)
        ...
        for batch in training_loader:
            ...
            if count_event % 1000 == 0:
                ...
                if count_event == 3000 and best_validation_quant >= 0.132:
                    ...
                    converge = True
                    break
                elif count_event == 1000 and best_validation_quant >= 0.15:
                    converge = True
                    break
