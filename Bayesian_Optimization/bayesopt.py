...
def arg_parse():
    ...
    parser.set_defaults(model_type='Gated',
                        ...
                        save_dir="/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt6/perfquant1dropout/",
                        )
    ...
    while converge == False:
        ...
        for batch in training_loader:
            ...
            if count_event % 1000 == 0:
                ...
                if count_event == 8000 or valid_loss >= 0.5:
                    converge = True
                    break
...
def main():
    ...
    s2 = "Best trial: ".format(str(trial.number))
    f = open("datphys6dropout.txt", "w")
    f.write(s)
    f.write(s2)
    f.close()
    ...
    fig1.write_image(file = "/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt6/perfquant1dropout/opt_history4var.png", format = 'png')
    fig2.write_image(file = "/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt6/perfquant1dropout/param_importances4var.png", format='png')
    fig3.write_image(file = "/depot/cms/users/jprodger/PUPPI/Physics_Optimization/PhysicsOpt6/perfquant1dropout/edf4var.png", format='png')
