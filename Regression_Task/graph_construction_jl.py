...
def main_regression(dR = 0.4):
    ...
    num_events_train = 700
    oname = r"D:\Data\Research\PUPPI\Regression_Data\W\train" + str(num_events_train) + "_reco"
    ...
    fp.close()
    num_events_valid = 150
    oname = r"D:\Data\Research\PUPPI\Regression_Data\W\valid" + str(num_events_valid) + "_reco"
    dataset_test = r_prepare_dataset(iname, num_events_valid, dR, num_events_train)
    with open(oname, "wb") as fp:
        pickle.dump(dataset_test, fp)
    fp.close()
    num_events_test = 150
    oname = r"D:\Data\Research\PUPPI\Regression_Data\W\test" + str(num_events_test) + "_reco"
